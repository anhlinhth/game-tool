...
require_once ROOT_APPLICATION.DS.'modules'.DS.'localize'.DS.'models'.DS.'Models_Language.php';


class Localize_LanguageController extends BaseController
{
	...
	public function indexAction(){
		...
		if(isset($_REQUEST['status'])&&isset($_REQUEST['id']))
		{
			if($language->checkstatus('1')||$_REQUEST['status']==1)
			{
				...
				$this->_redirect('/localize/language');
			}
			else 
