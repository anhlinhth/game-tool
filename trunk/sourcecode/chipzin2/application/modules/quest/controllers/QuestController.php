...
class Quest_QuestController extends Base_Controller
{
	...
	try
		{
			...
			$md= new Quest_Model_Quest();
			$mdqd = new Quest_Model_QuestDetail();
			$md_questLine = new Quest_Model_QuestLine();		
	...
	{		
		try
		{
			...
			{	
				...
				$md = new Quest_Model_QuestDetail();				
				$md->update($form->obj);				
				//////////////////Update Award Item////////////////////////////
	...
	{			
		try{
			...
			$md_getmax= new Quest_Model_Quest();
			...
			{	
				...
				$mdNextquest=new Quest_Model_QuestDetail();
	...
	public function updatenextquestAction()
	{
		try{
			...
			require_once ROOT_APPLICATION_MODELS.DS.'Quest_Model_Quest.php';
			require_once ROOT_APPLICATION_MODELS.DS.'Quest_Model_QuestDetail.php';
			require_once ROOT_APPLICATION_OBJECT.DS.'Obj_Quest_NextQuest.php';
			$this->_helper->layout->disableLayout();
			$this->_helper->viewRenderer->setNoRender();
			if($this->_request->isPost())
