...
// require_once ROOT_APPLICATION.DS.'modules'.DS.'localite'.DS.'models'.DS.'Localize_Model_Export.php';

class Localize_StringController extends Base_Controller
{
	...
	{
		$string = new Models_String();
		$model = new Localize_Model_Export();
