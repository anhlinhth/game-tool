...
require_once ROOT_APPLICATION.DS.'modules'.DS.'localize'.DS.'models'.DS.'Iefile.php';
require_once ROOT_APPLICATION.DS.'modules'.DS.'localize'.DS.'models'.DS.'Group.php';

class Localize_IEFileController extends BaseController
{
public function _setUserPrivileges()
	...
	public function indexAction(){	
		$model = new Models_Localize_Iefile();
